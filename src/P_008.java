...
public class P_008 {
    public static void main(String[] args) {
        ...
        BigInteger maxNumber=new BigInteger(String.valueOf(0));
        for (int i = 0; i < nums.length()-12; i++) {
            String number = nums.substring(i,i+13);
            BigInteger multiplied = multiplyAllDigitsOfNumber(number);
            maxNumber = maxNumber.max(multiplied);
        }
